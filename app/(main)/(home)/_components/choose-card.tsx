  ...
  return (
    <div className="my-20 flex flex-wrap justify-center gap-5 w-[95%] mx-auto">
      ...
      <div className="relative">
        <div className="absolute w-[300px] -top-12 z-0 -left-12 aspect-square dark:bg-transparent bg-[#69bfe7a7] blur-[150px] "></div>
      ...
      <div className="relative">
        <div className="absolute w-[300px] -top-12 z-0 -left-12 aspect-square dark:bg-transparent bg-[#ff9f3177] blur-[150px] "></div>
...
const Card1 = ({ cardData }: any) => {
  return (
    <div
      className={`relative flex flex-col justify-between w-[336px] h-[435px] z-10 border border-transparent rounded-[30px] hover:bg-transparent bg-white dark:hover:bg-black dark:bg-[#1b1c1e] hover:border-[#34D4AE] group pt-8 p-6`}
    >
...
const Card2 = ({ cardData }: any) => {
  return (
    <div
      className={`relative flex flex-col justify-between w-[336px] h-[435px] bg-white dark:hover:bg-black hover:bg-transparent z-10 border-transparent rounded-[30px] dark:bg-[#1b1c1e] hover:border-[#69C0E7] group border pt-8 p-6`}
    >
...
const Card3 = ({ cardData }: any) => {
  return (
    <div
      className={`relative flex flex-col justify-between w-[336px] h-[435px] dark:hover:bg-black bg-white hover:bg-transparent z-10 border-transparent rounded-[30px] dark:bg-[#1b1c1e] hover:border-[#FF605F] group border pt-8 p-6`}
    >
      {/* <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-[#01c99b] via-teal-100 to-transparent blur-2xl opacity-35 z-0"></div> */}
      <p className="text-2xl font-semibold">{cardData.title}</p>
...
const Card4 = ({ cardData }: any) => {
  return (
    <div
      className={`relative flex flex-col justify-between w-[336px] h-[435px] bg-white dark:hover:bg-black  hover:bg-transparent z-10  border-transparent rounded-[30px] dark:bg-[#1b1c1e] hover:border-[#FF9F31] group border pt-8 p-6`}
    >
      {/* <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-[#01c99b] via-teal-100 to-transparent blur-2xl opacity-35 z-0"></div> */}
      <p className="text-2xl font-semibold">{cardData.title}</p>
